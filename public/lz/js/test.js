    ...
    var clss=['one','two','three','four','five','six','seven','eight','nine','ten','eleven','twelve','thirteen','fourteen','fifteen'];
    ...
    sc=new Screen('inner',{ballsnum:12, spring:1, bounce:-0.9, gravity:0});
    sc.initialize();
